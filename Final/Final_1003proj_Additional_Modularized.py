...
def openfile(file_path, studentsPerGrp):
    ...
    with open(file_path, mode='r', newline='') as file:
        ...
        classes = [[] for _ in range(120)]  # Create a list for each class
...
def sortGroups(classes, studentsPerGrp):
    ...
    for eachClass in sorted_classes:
        ...
        GenderList.append([MaleCounter / noOfGrps, FemaleCounter / noOfGrps])
...
def writefile(final_groups):
    output_file_path = 'FCE4_4_Spencer.csv'
